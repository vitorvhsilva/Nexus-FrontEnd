  ...
  return (
    <main className="w-full h-fit font-poppins">
      ...
      <div className="w-[95%] h-fit grid md:grid-cols-3 grid-cols-1 gap-12 mx-auto">
        ...
        e intuitivo do seu automóvel"/>
        <Funcionalidade img="./imgs/icones/dinheiro.png" titulo="Orçamento" subtitulo="Orçamento com I.A baseado no Diagnóstico do seu veículo"/>
        <Funcionalidade img="./imgs/icones/agenda.png" titulo="Agendamento" subtitulo="Agende um conserto para o seu veículo com base no seu endereço"/>
      </div>
