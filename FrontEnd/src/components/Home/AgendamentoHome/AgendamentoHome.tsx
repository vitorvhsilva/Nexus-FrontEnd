  ...
  return (
    <section className="w-full h-fit py-10 flex justify-around items-center bg-corFundoCinza lg:flex-row flex-col lg:gap-0 gap-10">
      ...
      <div className="w-[50%] h-full flex justify-center items-center gap-8 md:flex-row flex-col">
        <img src="./imgs/fotos/mecanico2.jpg" alt="Foto de um mecânico" className="w-auto h-80 xl:h-96 rounded-2xl hover:scale-105 transition duration-700"/>
        <img src="./imgs/fotos/mecanico3.jpg" alt="Foto de um mecânico" className="w-auto h-80 xl:h-96 rounded-2xl hover:scale-105 transition duration-700"/>
      </div>
    </section>
  )
}