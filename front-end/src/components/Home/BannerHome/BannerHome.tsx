  ...
  return (
    <section className="w-full h-[80vh] bg-corFundoCinza flex justify-around items-center lg:flex-row flex-col">
      ...
      <div className="w-[60%] lg:w-[40%] h-fit">
        <Image src='/imgs/fotos/mecanico1.jpg' alt="Homem mexendo em um motor de carro" className="w-full h-full rounded-xl hover:scale-110 duration-700 transition hover:shadow-cor1 shadow-xl" width={500} height={500}/>
      </div>
    </section>
  )
}