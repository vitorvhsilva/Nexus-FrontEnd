...
export default function VeiculoUsuarioDiagnostico({marca, modelo, ano, placa, tipo, aoClicar, selecionado}:TipoVeiculoUsuario & {selecionado: boolean, aoClicar: () => void}) {
